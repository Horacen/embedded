...
#define LED1_OFF         ANO_GPIO_LED->BRR = ANO_Pin_LED1          //BSRRL   LEVEL_H
#define LED1_ON          ANO_GPIO_LED->BSRR = ANO_Pin_LED1		//L
#define LED2_ON          ANO_GPIO_LED->BSRR = ANO_Pin_LED2
#define LED2_OFF         ANO_GPIO_LED->BRR = ANO_Pin_LED2
#define LED3_ON          ANO_GPIO_LED->BSRR = ANO_Pin_LED3
#define LED3_OFF         ANO_GPIO_LED->BRR = ANO_Pin_LED3

/***************LED GPIO定义******************/
#define ANO_RCC_LED			RCC_APB2Periph_GPIOB
#define ANO_GPIO_LED		GPIOB
#define ANO_Pin_LED1		GPIO_Pin_3		//G
#define ANO_Pin_LED2		GPIO_Pin_2		//R
#define ANO_Pin_LED3		GPIO_Pin_1		//B
/*********************************************/
/*
		case 0:
		{
