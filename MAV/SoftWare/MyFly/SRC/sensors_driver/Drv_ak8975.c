...
void Drv_AK8975CSPin_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(AK8975_CS_RCC, ENABLE);
...
{	
	...
	ak8975_enable(1);
	Drv_SPI1_RW(AK8975_HXL_REG|0x80);
	for(u8 i=0; i<6; i++)
		ak8975_buf[i] = Drv_SPI1_RW(0xff);
	ak8975_enable(0);
...
/******************* (C) COPYRIGHT 2017 My TECH *****END OF FILE************/
