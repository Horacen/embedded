...
#define SYS_TIMx					TIM4
#define SYS_RCC_TIMx			RCC_APB1Periph_TIM4

void TIM_CONF()   //APB1  36M
{
...
void  SysTick_Configuration ( void )
{
    ...
    cnts = ( uint32_t ) rcc_clocks.HCLK_Frequency / TICK_PER_SECOND;	//72 000 000 / 1000
    cnts = cnts / 8;
