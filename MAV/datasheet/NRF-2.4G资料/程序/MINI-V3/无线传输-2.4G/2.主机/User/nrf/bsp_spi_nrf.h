...
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOC, GPIO_Pin_6)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOC, GPIO_Pin_6)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOC,GPIO_Pin_5)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOC,GPIO_Pin_5)			      //CE置低
